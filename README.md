...
- [AI Assistant](web/src/features/assistant/README.md) provides a ChatGPT-style chat interface integrated directly into your Langfuse project. Chat with AI assistants powered by your configured LLM providers (OpenAI, Google AI, etc.), with full conversation history and automatic tracing of all interactions for observability and analysis.
